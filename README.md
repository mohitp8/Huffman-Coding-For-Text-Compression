...
Enter text on Laptop 1.
Build a Huffman tree and code table.
Compress the text into a bitstream.
Pack the bits into bytes.
Build a framed TCP message containing the Huffman codebook and compressed data.
Transmit the frame to Laptop 2 over the same Wi-Fi/LAN.
Receive, unpack, reconstruct the codebook, and Huffman-decode.
Verify the received message.
Display the logical compressed bitstream as an NRZ waveform.
Requirements
...
ipconfig
Look for the IPv4 address of the Wi-Fi adapter, for example: 192.168.1.25
